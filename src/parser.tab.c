...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NULL_TOKEN = 7,                 /* NULL_TOKEN  */
  YYSYMBOL_8_ = 8,                         /* '{'  */
  YYSYMBOL_9_ = 9,                         /* '}'  */
  YYSYMBOL_10_ = 10,                       /* ','  */
  YYSYMBOL_11_ = 11,                       /* ':'  */
